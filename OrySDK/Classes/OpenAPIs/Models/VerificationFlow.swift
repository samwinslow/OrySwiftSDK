...
public struct VerificationFlow: Codable, JSONEncodable, Hashable {
    ...
    public var state: VerificationFlowState
    /** The flow type can either be `api` or `browser`. */
    public var type: String
    public var ui: UiContainer

    public init(active: String? = nil, expiresAt: Date? = nil, id: String, issuedAt: Date? = nil, requestUrl: String? = nil, returnTo: String? = nil, state: VerificationFlowState, type: String, ui: UiContainer) {
        self.active = active
