//
// OAuth2ConsentRequestOpenIDConnectContext.swift
//
...
public struct OAuth2ConsentRequestOpenIDConnectContext: Codable, JSONEncodable, Hashable {
    ...
    public var idTokenHintClaims: [String: AnyCodable]?
    ...
    public init(acrValues: [String]? = nil, display: String? = nil, idTokenHintClaims: [String: AnyCodable]? = nil, loginHint: String? = nil, uiLocales: [String]? = nil) {
